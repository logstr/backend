...
class Coupon(object):
    @classmethod
    def create(self, code=None, duration=None, amount_off=None,
...
class Card(object):
    @classmethod
    def update(self, customer_id, stripe_token=None):
        """
...
class Subscription(object):
    @classmethod
    def create(self, token=None, email=None, coupon=None, plan=None):
        """
    ...
    @classmethod
    def update(self, customer_id=None, coupon=None, plan=None):
        """
    ...
    @classmethod
    def cancel(self, customer_id=None):
        """
...
class Plan(object):
    ...
    @classmethod
    def create(self, id=None, name=None, amount=None, currency=None,
    ...
    @classmethod
    def update(self, id=None, name=None, metadata=None,
